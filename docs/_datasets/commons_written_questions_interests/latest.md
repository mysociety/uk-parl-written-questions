...
- title: Written questions with interests declared
  ...
  schema:
    ...
    - name: answerText
      ...
      constraints:
        unique: false
      example: ' In our new Road Safety Strategy, published on 7 January 2026 we announced
        that we will pilot a National Work-Related Road Safety Charter for businesses
        that require people to drive or ride for them. This includes the use of HGVs,
        Light Goods Vehicles (LG...'
  ...
  hash: 8a0065f24fc9c273d7046d0e56ee9287
full_version: 0.1.0
