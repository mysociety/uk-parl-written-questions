...
custom:
  ...
  composite:
    ...
    json:
      ...
      render: false
  change_log:
    0.1.0: 'Existing resource field(s) removed: askingMember,correctingMember,answeringMember'
  datasette:
...
- title: Written question
  ...
  schema:
    ...
    - name: heading
      ...
      constraints:
        unique: false
      example: ' Department of Health and Social Care and Food Standards Agency: Finance'
    - name: attachments
      type: string
  ...
  hash: c759d66bdbbb81304dcfcef83870b049
full_version: 0.1.0
